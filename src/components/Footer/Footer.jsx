      ...
      <div className="w-full max-w-screen-xl p-4 py-6 mx-auto lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="font-medium text-gray-500">
                <li className="justify-center mb-4">
                  <Link to="/" className="self-center hover:underline">
                    Home
                  </Link>
                </li>
                <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">
            ...
            <span> </span>
            <a href="https://mcc1461.com/" className="font-extrabold hover:underline ">
              mcc1461
            </a>
            <span> ~ </span>
            All Rights Reserved.
          ...
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            <a  href="https://github.com/mcc1461" className="text-gray-500">
              <svg
                width="24px"
                height="24px"
                viewBox="0 0 24 24"
            ...
            <a  href="https://www.linkedin.com/in/mcoskuncelebi" className="text-gray-500">
              <svg
                width="24px"
                height="24px"
                viewBox="0 0 73 73"
